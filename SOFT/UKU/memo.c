...
MODBUS_BAUDRATEA=lc640_read_int(EE_MODBUS_BAUDRATEA);
MODBUS_BAUDRATEB=lc640_read_int(EE_MODBUS_BAUDRATEB);
...
//MODBUS_BAUDRATE=960;
RELE_LOG_CURR=lc640_read_int(EE_RELE_LOG_CURR);
RELE_LOG_VOLT=lc640_read_int(EE_RELE_LOG_VOLT);
T_DEL_REL_CURR_START=lc640_read_int(EE_T_DEL_REL_CURR_START);		
T_DEL_REL_CURR_WRK=lc640_read_int(EE_T_DEL_REL_CURR_WRK);
T_DEL_REL_VOLT_START=lc640_read_int(EE_T_DEL_REL_VOLT_START);		
T_DEL_REL_VOLT_WRK=lc640_read_int(EE_T_DEL_REL_VOLT_WRK);			
DELT_REL_CURR_U=lc640_read_int(EE_DELT_REL_CURR_U);				
DELT_REL_CURR_I=lc640_read_int(EE_DELT_REL_CURR_I);
REL_VOLT_UMAX=lc640_read_int(EE_REL_VOLT_UMAX);				
REL_VOLT_UMIN=lc640_read_int(EE_REL_VOLT_UMIN);
...
ACH_OFF_EN=lc640_read_int(EE_ACH_OFF_EN);
ACH_OFF_LEVEL=lc640_read_int(EE_ACH_OFF_LEVEL);
CURR_OFF_EN=lc640_read_int(EE_CURR_OFF_EN);
CUR_OFF_LEVEL_RELATIV=lc640_read_int(EE_CUR_OFF_LEVEL_RELATIV);
CUR_OFF_LEVEL_ABSOLUT=lc640_read_int(EE_CUR_OFF_LEVEL_ABSOLUT);
CUR_OFF_T_OFF=lc640_read_int(EE_CUR_OFF_T_OFF);
...
RELE_FUNC[0]=lc640_read_int(EE_RELE_FUNC1);
RELE_FUNC[1]=lc640_read_int(EE_RELE_FUNC2);
//gran(&NUMINV,0,8);
...
UOUT_OFF_EN=lc640_read_int(EE_UOUT_OFF_EN);	
UOUT_OFF_LEVEL=lc640_read_int(EE_UOUT_OFF_LEVEL);	
UOUT_OFF_DELAY=lc640_read_int(EE_UOUT_OFF_DELAY);	
