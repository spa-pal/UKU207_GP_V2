...
#line 120 "C:\\Keil\\ARM\\RV31\\INC\\Net_lib.c"
 ...
 HTTP_INFO http_session[6];
 U8  const http_NumSess  = 6;
 U8  const http_EnAuth   = 0;
 U16 const http_PortNum  = 80;
 U8  const http_auth_dev[]     = "Embedded WEB Server";
 U8  const http_auth_user[]    = "admin";
 U8        http_auth_passw[20] = "";
