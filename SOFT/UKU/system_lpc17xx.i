...
#line 446 "system_LPC17xx.c"
  ((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->USBCLKCFG = 0x00000000;     


  ((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->PCONP     = 0x4000F14A;         
  ...
  if (((((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->PLL0STAT >> 24)&3)==3) { 
    ...
    switch (((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->CLKSRCSEL & 0x03) {
      ...
      case 3:                            
        ...
        break;
      case 1:                            
        SystemFrequency = ( (10000000UL)) / ((((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->CCLKCFG & 0xFF)+ 1);
        break;
      case 2:                            
        SystemFrequency = ( 32000UL) / ((((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->CCLKCFG & 0xFF)+ 1);
        break;
    }
  }


  ((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->FLASHCFG  = 0x0000303A;
