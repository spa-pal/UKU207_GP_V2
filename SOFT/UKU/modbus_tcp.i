...
switch (evt) 
	...
	if(modbus_tcp_unit==MODBUS_ADRESS)
		...
		if(modbus_tcp_func==4)		
			...
			if((modbus_tcp_rx_arg0!=90)&&(modbus_tcp_rx_arg0!=91)&&(modbus_tcp_rx_arg0!=92)&&(modbus_tcp_rx_arg0!=93)) lc640_write_int(0x10+60,EE_WRITE_CNT+1);


			}


		else if(modbus_tcp_func==16) 	
			{
			U8 *sendbuf;
			...
			for(i=0;i<modbus_tcp_rx_arg1;i++)
				...
				if((modbus_tcp_rx_arg0+i)==50)		
					{
					I_ug=modbus_tcp_write_args[i];
					lc640_write_int(0x10+16,I_ug);
					}
				else if((modbus_tcp_rx_arg0+i)==51)	
					{
					U_up=modbus_tcp_write_args[i];
					lc640_write_int(0x10+18,U_up);
					}
				else if((modbus_tcp_rx_arg0+i)==52)		
					{
					U_maxg=modbus_tcp_write_args[i];
					lc640_write_int(0x10+100+2,U_maxg);
					}
				else if((modbus_tcp_rx_arg0+i)==53)		
					{
					I_maxp=modbus_tcp_write_args[i];
					lc640_write_int(0x10+100+4,I_maxp);
					}								
				else if((modbus_tcp_rx_arg0+i)==54)		
					{
					signed long sec,min,hour;
				...
				else if((modbus_tcp_rx_arg0+i)==55)		
					{
					signed long sec,min,hour;
					sec=T_PROC_GS%60L;
				...
				else if((modbus_tcp_rx_arg0+i)==56)		
					{
					signed long sec,min,hour;
					sec=T_PROC_GS%60L;
					min=(T_PROC_GS/60L)%60L;
				...
				else if((modbus_tcp_rx_arg0+i)==57)		
					{
					signed long sec,min,hour;
					sec=(signed long)modbus_tcp_write_args[i];
					min=(T_PROC_PS/60L)%60L;
				...
				else if((modbus_tcp_rx_arg0+i)==58)		
					{
					signed long sec,min,hour;
					sec=T_PROC_PS%60L;
					min=(signed long)modbus_tcp_write_args[i];
				...
				else if((modbus_tcp_rx_arg0+i)==59)		
					{
					signed long sec,min,hour;
					sec=T_PROC_PS%60L;
					min=(T_PROC_PS/60L)%60L;
	 			...
	 			else if((modbus_tcp_rx_arg0+i)==60)		
					{
				...
				else if((modbus_tcp_rx_arg0+i)==61)		
					{
					if(modbus_tcp_write_args[i]==1)
						{
						if(work_stat!=wsGS)
				...
				else if((modbus_tcp_rx_arg0+i)==62)		
					{
						{
						if(work_stat==wsOFF)
							{
				...
				else if((modbus_tcp_rx_arg0+i)==63)		
					{
						{
						if((work_stat==wsOFF)&&(REV_IS_ON))
							{
				...
				else if((modbus_tcp_rx_arg0+i)==64)		
					{
					if(work_stat==wsOFF)
						{
				...
				else if((modbus_tcp_rx_arg0+i)==65)		
					{
					if(work_stat==wsOFF)
						{
				...
				else if((modbus_tcp_rx_arg0+i)==66)		
					{
					if(work_stat==wsOFF)
						{
				...
				else if((modbus_tcp_rx_arg0+i)==67)		
					{
					if(work_stat==wsOFF)
						{
				...
				else if((modbus_tcp_rx_arg0+i)==68)		
					{
					if(work_stat==wsOFF)
						{
				...
				else if((modbus_tcp_rx_arg0+i)==69)		
					{
					if(work_stat==wsOFF)
						{
				...
				else if((modbus_tcp_rx_arg0+i)==70)		
					{
					if(work_stat==wsOFF)
						{
				...
				else if((modbus_tcp_rx_arg0+i)==71)		
					{
					if(work_stat==wsOFF)
						{
				...
				else if((modbus_tcp_rx_arg0+i)==72)		
					{
					if(work_stat==wsOFF)
						{
				...
				else if((modbus_tcp_rx_arg0+i)==73)		
					{
					if(work_stat==wsOFF)
						{
				...
				else if((modbus_tcp_rx_arg0+i)==74)		
					{
					if(work_stat==wsOFF)
						{
				...
				else if((modbus_tcp_rx_arg0+i)==75)		
					{
					if(work_stat==wsOFF)
						{
				...
				else if((modbus_tcp_rx_arg0+i)==76)		
					{
					if(work_stat==wsOFF)
						{
				...
				else if((modbus_tcp_rx_arg0+i)==77)		
					{
				...
				if((modbus_tcp_rx_arg0+i)==90)		
					{
					I_ug_ram=modbus_tcp_write_args[i];
					eepromRamSwitch=1;
					}

				else if((modbus_tcp_rx_arg0+i)==91)	
					{
