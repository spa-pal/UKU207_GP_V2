...
{
((LPC_PINCON_TypeDef *) ((0x40000000UL) + 0x2C000) )->PINSEL0 = ( (((LPC_PINCON_TypeDef *) ((0x40000000UL) + 0x2C000) )->PINSEL0 & ~((0xffffffff>>(32-2))<<0*2)) | ((unsigned)0 << 0*2) );
((LPC_PINCON_TypeDef *) ((0x40000000UL) + 0x2C000) )->PINSEL0 = ( (((LPC_PINCON_TypeDef *) ((0x40000000UL) + 0x2C000) )->PINSEL0 & ~((0xffffffff>>(32-2))<<15*2)) | ((unsigned)3 << 15*2) );
((LPC_PINCON_TypeDef *) ((0x40000000UL) + 0x2C000) )->PINSEL1 = ( (((LPC_PINCON_TypeDef *) ((0x40000000UL) + 0x2C000) )->PINSEL1 & ~((0xffffffff>>(32-2))<<(16-16)*2)) | ((unsigned)0 << (16-16)*2) );
((LPC_PINCON_TypeDef *) ((0x40000000UL) + 0x2C000) )->PINSEL1 = ( (((LPC_PINCON_TypeDef *) ((0x40000000UL) + 0x2C000) )->PINSEL1 & ~((0xffffffff>>(32-2))<<(17-16)*2)) | ((unsigned)3 << (17-16)*2) );
((LPC_PINCON_TypeDef *) ((0x40000000UL) + 0x2C000) )->PINSEL1 = ( (((LPC_PINCON_TypeDef *) ((0x40000000UL) + 0x2C000) )->PINSEL1 & ~((0xffffffff>>(32-2))<<(18-16)*2)) | ((unsigned)3 << (18-16)*2) ); 


 

((LPC_SPI_TypeDef *) ((0x40000000UL) + 0x20000) )->SPCCR=20;
...
short i;
sc16is700_spi_init();
{long xx; xx=(unsigned long)2 * 12UL; while(xx)xx--;};
((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIODIR|=(1<<0);((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIOCLR|=(1<<0); 
spi1((reg_num&0x0f)<<3);
for (i=0;i<num;i++)spi1(tx_buffer_sc16is700[i]);
((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIODIR|=(1<<0);((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIOSET|=(1<<0);
}
...
sc16is700_wr_byte(0x00, 0x41);
sc16is700_wr_byte(0x01, 0x00);
sc16is700_wr_byte(0x03, 0xBF);
sc16is700_wr_byte(0x02, 0X10);
sc16is700_wr_byte(0x03, 0x03);
sc16is700_wr_byte(0x02, 0x06);
sc16is700_wr_byte(0x02, 0x01);
sc16is700_wr_byte(0x0f, 0X30);
...
if (++tx_wr_index_sc16is700 == 32) tx_wr_index_sc16is700=0;
}
