...
char flag0;
char rx_buffer0[1024];
char tx_buffer0[1024];
...
void putchar0(char c)
{
while (tx_counter0 == 1024);
if (tx_counter0 || ((((LPC_UART0_TypeDef *) ((0x40000000UL) + 0x0C000) )->LSR & 0x60)==0))
   {
   tx_buffer0[tx_wr_index0]=c;
   if (++tx_wr_index0 == 1024) tx_wr_index0=0;
   ++tx_counter0;
   }
else ((LPC_UART0_TypeDef *) ((0x40000000UL) + 0x0C000) )->THR=c;
}
...
if ( PortNum == 0 )
  	{
	((LPC_PINCON_TypeDef *) ((0x40000000UL) + 0x2C000) )->PINSEL0 &= ~0x000000F0;
	((LPC_PINCON_TypeDef *) ((0x40000000UL) + 0x2C000) )->PINSEL0 |= 0x00000050;   
	
 
	 
	pclkdiv = (((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->PCLKSEL0 >> 6) & 0x03;
	switch ( pclkdiv )
		{
	  	case 0x00:
	  	default:
	...
	Fdiv = ( pclk / 16 ) / baudrate ;	 
    	((LPC_UART0_TypeDef *) ((0x40000000UL) + 0x0C000) )->DLM = Fdiv / 256;							
    	((LPC_UART0_TypeDef *) ((0x40000000UL) + 0x0C000) )->DLL = Fdiv % 256;
	((LPC_UART0_TypeDef *) ((0x40000000UL) + 0x0C000) )->LCR = 0x03;		 
    	((LPC_UART0_TypeDef *) ((0x40000000UL) + 0x0C000) )->FCR = 0x07;		 

   	NVIC_EnableIRQ(UART0_IRQn);

    	((LPC_UART0_TypeDef *) ((0x40000000UL) + 0x0C000) )->IER = 0x01 | 0x02 | 0x04;	 
    	return ((1));
  	}
else if ( PortNum == 1 )
  	{
...
if (++rx_rd_index0 == 1024) rx_rd_index0=0;
--rx_counter0;
return data;
}
...
IIRValue = ((LPC_UART0_TypeDef *) ((0x40000000UL) + 0x0C000) )->IIR;
    
IIRValue >>= 1;			 
IIRValue &= 0x07;			 
if ( IIRValue == 0x03 )		 
  	{
	LSRValue = ((LPC_UART0_TypeDef *) ((0x40000000UL) + 0x0C000) )->LSR;
	...
	if ( LSRValue & (0x02|0x04|0x08|0x80|0x10) )
		{
	  	...
	  	Dummy = ((LPC_UART0_TypeDef *) ((0x40000000UL) + 0x0C000) )->RBR;		
	...
	if ( LSRValue & 0x01 )	 			
		...
		data=((LPC_UART0_TypeDef *) ((0x40000000UL) + 0x0C000) )->RBR;
		rx_buffer0[rx_wr_index0]=data;
   		bRXIN0=1;
   		if (++rx_wr_index0 == 1024) rx_wr_index0=0;
   		if (++rx_counter0 == 1024)
      		{
      		rx_counter0=0;
	...
	if ( LSRValue & 0x20 )
		...
		if (tx_counter0)
   			{
   			--tx_counter0;
   			((LPC_UART0_TypeDef *) ((0x40000000UL) + 0x0C000) )->THR=tx_buffer0[tx_rd_index0];
   			if (++tx_rd_index0 == 1024) tx_rd_index0=0;
   			}
		}
	else
		{
...
if(	((UIB0[0]=='g')||(UIB0[0]=='G'))&&
	...
	temp_out[0]=*(((char*)&load_U));
	temp_out[1]=*(((char*)&load_U)+1);
	temp_out[2]=*(((char*)&load_I));
	temp_out[3]=*(((char*)&load_I)+1);
	uart_out_adr0(temp_out,4);
	}
