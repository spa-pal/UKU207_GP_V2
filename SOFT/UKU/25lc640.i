...
((LPC_SPI_TypeDef *) ((0x40000000UL) + 0x20000) )->SPDR=in;
while(!(((LPC_SPI_TypeDef *) ((0x40000000UL) + 0x20000) )->SPSR&(1<<7)));
return ((LPC_SPI_TypeDef *) ((0x40000000UL) + 0x20000) )->SPDR;
...
((LPC_PINCON_TypeDef *) ((0x40000000UL) + 0x2C000) )->PINSEL0 = ( (((LPC_PINCON_TypeDef *) ((0x40000000UL) + 0x2C000) )->PINSEL0 & ~((0xffffffff>>(32-2))<<15*2)) | ((unsigned)0 << 15*2) );
((LPC_PINCON_TypeDef *) ((0x40000000UL) + 0x2C000) )->PINSEL1 = ( (((LPC_PINCON_TypeDef *) ((0x40000000UL) + 0x2C000) )->PINSEL1 & ~((0xffffffff>>(32-2))<<(16-16)*2)) | ((unsigned)0 << (16-16)*2) );
((LPC_PINCON_TypeDef *) ((0x40000000UL) + 0x2C000) )->PINSEL1 = ( (((LPC_PINCON_TypeDef *) ((0x40000000UL) + 0x2C000) )->PINSEL1 & ~((0xffffffff>>(32-2))<<(17-16)*2)) | ((unsigned)0 << (17-16)*2) );
((LPC_PINCON_TypeDef *) ((0x40000000UL) + 0x2C000) )->PINSEL1 = ( (((LPC_PINCON_TypeDef *) ((0x40000000UL) + 0x2C000) )->PINSEL1 & ~((0xffffffff>>(32-2))<<(18-16)*2)) | ((unsigned)0 << (18-16)*2) );

((LPC_SPI_TypeDef *) ((0x40000000UL) + 0x20000) )->SPCR=0x00;
}
...
((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIODIR|=(1UL<<20);((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIOCLR|=(1UL<<20);
