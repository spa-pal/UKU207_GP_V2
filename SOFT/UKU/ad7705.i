...
((LPC_SPI_TypeDef *) ((0x40000000UL) + 0x20000) )->SPCR=0x38;
}
...
((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00040) )->FIODIR|=(1<<13);

((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00040) )->FIOCLR|=(1<<13);
{long xx; xx=(unsigned long)10 * 12000UL; while(xx)xx--;};

((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00040) )->FIOPIN|=(1<<13);
}
...
((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIODIR|=(1UL<<11);

((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIOPIN|=(1UL<<11);
spi1_ad7705_config();

for(i=0;i<5;i++)((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00000) )->FIOPIN&=~(1UL<<11);
spi1(in);
