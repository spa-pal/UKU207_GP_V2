...
#targetDir = "P:\\ПТЭСТ\\ИПС_ЛАБОРАТОРНЫЙ\\"
targetDir = "P:\\Прошивки2018\\ИПС_ЛАБОРАТОРНЫЙ\\"
source_file = 'curr_version.c'
source_file1 = ".\\EXE\\UKU2071x_GALV_IBv2.hex"

version_string = 'const short HARDWARE_VERSION = {};'
...
target_file=targetDir_+ "\\ips_lab_"+"_"+build_year+"_"+build_month+"_"+build_day+"__"+version+"."+subversion+"."+build+".hex"
