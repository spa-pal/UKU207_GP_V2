...
void delayMs(uint8_t timer_num, uint32_t delayInMs)
{
  if ( timer_num == 0 )
  {
	((LPC_TIM_TypeDef *) ((0x40000000UL) + 0x04000) )->TCR = 0x02;		 
	((LPC_TIM_TypeDef *) ((0x40000000UL) + 0x04000) )->PR  = 0x00;		 
	((LPC_TIM_TypeDef *) ((0x40000000UL) + 0x04000) )->MR0 = delayInMs * (9000000 / 1000-1);
	((LPC_TIM_TypeDef *) ((0x40000000UL) + 0x04000) )->IR  = 0xff;		 
	((LPC_TIM_TypeDef *) ((0x40000000UL) + 0x04000) )->MCR = 0x04;		 
	((LPC_TIM_TypeDef *) ((0x40000000UL) + 0x04000) )->TCR = 0x01;		 
  
	 
	while (((LPC_TIM_TypeDef *) ((0x40000000UL) + 0x04000) )->TCR & 0x01);
  }
  else if ( timer_num == 1 )
  {
	((LPC_TIM_TypeDef *) ((0x40000000UL) + 0x08000) )->TCR = 0x02;		 
	((LPC_TIM_TypeDef *) ((0x40000000UL) + 0x08000) )->PR  = 0x00;		 
	((LPC_TIM_TypeDef *) ((0x40000000UL) + 0x08000) )->MR0 = delayInMs * (9000000 / 1000-1);
	((LPC_TIM_TypeDef *) ((0x40000000UL) + 0x08000) )->IR  = 0xff;		 
	((LPC_TIM_TypeDef *) ((0x40000000UL) + 0x08000) )->MCR = 0x04;		 
	((LPC_TIM_TypeDef *) ((0x40000000UL) + 0x08000) )->TCR = 0x01;		 
  
	 
	while (((LPC_TIM_TypeDef *) ((0x40000000UL) + 0x08000) )->TCR & 0x01);
  }
  return;
}
