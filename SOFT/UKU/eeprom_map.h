...
#define EE_T_DEL_REL_START			SECTOR_SETS+134
#define EE_T_DEL_REL_WRK				SECTOR_SETS+136
#define EE_DELT_REL_U				SECTOR_SETS+138
#define EE_DELT_REL_I				SECTOR_SETS+140
