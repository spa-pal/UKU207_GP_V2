...
void beep_drv(void)
{
((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00020) )->FIODIR|=(1UL<<31);
if((beep_stat_temp&0x00000001UL)&&(ZV_ON))
    	{
    	((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00020) )->FIOSET|=(1UL<<31);
    	beep_cnt=6;
    	}
else ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00020) )->FIOCLR|=(1UL<<31);
